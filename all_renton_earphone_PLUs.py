...
def getPage(num_page):
    ...
    resp = requests.get('https://www.frys.com/search?storeNo=30,&cat=-68978&pType=pDisplay&rows=20&fq=a%20Regular%20Items-100722%20Over__Ear-100722%20On__Ear-100722%20In__Ear&resultpage={}&start={}&rows=20'.format(num_page, num_page * 20),
...
def getAllPLUs(num_of_pages):
    ...
    while(i < num_of_pages):  # iterating through ll result pages
        ...
        soup_page = getPage(i)
        plu_nums = getPLUs(soup_page)  # string
        all_plus.append(plu_nums)
        i += 1
    return all_plus
